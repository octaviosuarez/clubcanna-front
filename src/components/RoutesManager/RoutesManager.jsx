        ...
        <div className={`flex ${isMobile ? 'flex-col' : 'flex-row'} w-screen`}>
            ...
            <div className={`w-full`} style={{
                ...
                <Routes>
                    ...
                    <Route path="/socios" element={<PrivateRoute required="admin">
                        <Socios />
                    </PrivateRoute>} />
                    <Route path="/socios/:cedula" element={<PrivateRoute required="admin">
                        <Socio />
                    </PrivateRoute>} />
                    <Route path="/stock" element={<PrivateRoute required="admin">
                        <Stock />
                    </PrivateRoute>} />
                    <Route path="/stock/:id" element={<PrivateRoute required="admin">
                        <Raza />
                    </PrivateRoute>} />
                    <Route path="/pedidos" element={<PrivateRoute required="admin">
                        <Pedidos />
                    </PrivateRoute>} />
                    <Route path="/mis-pedidos" element={<PrivateRoute required="user">
                        <MisPedidos />
                    </PrivateRoute>} />
