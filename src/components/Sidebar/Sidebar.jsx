    ...
    const SidebarContent = () => (
        <div className="flex flex-col gap-2">
            {sidebarOptionsFiltered.map(option => {
                ...
                return (
                    <div
                        onClick={() => { handleNavigate(option.link); setActiveOption(option.id); }}
                        key={option.id}
                ...
                <>
                    ...
                    <div className="flex items-center justify-between p-4 border-b border-gray-300 lg:hidden dark:border-gray-700">
                        <User
                            ...
                            description={userData?.level === "user" ? "Usuario" : "Administrador"}
                            avatarProps={{
                                src: logoSrc
                            }}
                        />
                    ...
                    {/* Mobile Sidebar */}
                    <div className={`lg:hidden fixed z-50 top-0 left-0 w-full h-[100dvh] flex-col max-h-[100dvh] bg-white dark:bg-gray-800 transition-transform transform ${menuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                        <div className="flex flex-col h-[100dvh] p-4">
                            ...
                            <div className="self-end w-full mt-auto">
                                <Dropdown className="w-full">
                                    <DropdownTrigger>
                                        <Button className="w-full" variant="bordered">Opciones</Button>
                                    </DropdownTrigger>
